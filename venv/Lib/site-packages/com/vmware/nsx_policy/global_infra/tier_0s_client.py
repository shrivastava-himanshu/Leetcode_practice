...
class Evpn(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.tier_0s.evpn'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _EvpnStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/tier-0s/{tier-0-id}/evpn',
            path_variables={
                'tier0_id': 'tier-0-id',
            },
            query_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.tier_0s.evpn',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
