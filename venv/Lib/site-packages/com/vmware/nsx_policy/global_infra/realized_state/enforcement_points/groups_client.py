...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.groups.
#---------------------------------------------------------------------------
...
class Nsgroups(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.groups.nsgroups'
    """
...
class Securitygroups(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.groups.securitygroups'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _NsgroupsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/realized-state/enforcement-points/{enforcement-point-name}/groups/nsgroups/{nsgroup-name}',
            path_variables={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/realized-state/enforcement-points/{enforcement-point-name}/groups/nsgroups',
            path_variables={
                'enforcement_point_name': 'enforcement-point-name',
            },
            query_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.groups.nsgroups',
...
class _SecuritygroupsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/realized-state/enforcement-points/{enforcement-point-name}/groups/securitygroups/{securitygroup-name}',
            path_variables={
                'enforcement_point_name': 'enforcement-point-name',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/realized-state/enforcement-points/{enforcement-point-name}/groups/securitygroups',
            path_variables={
                'enforcement_point_name': 'enforcement-point-name',
            },
            query_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.groups.securitygroups',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
