...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.ip_sets.
#---------------------------------------------------------------------------
...
class IpSetsNsxt(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.ip_sets.ip_sets_nsxt'
    """
