...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.services.
#---------------------------------------------------------------------------
...
class Nsservices(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.services.nsservices'
    """
...
class _NsservicesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/realized-state/enforcement-points/{enforcement-point-name}/services/nsservices/{nsservice-name}',
            path_variables={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/realized-state/enforcement-points/{enforcement-point-name}/services/nsservices',
            path_variables={
                'enforcement_point_name': 'enforcement-point-name',
            },
            query_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.services.nsservices',
