...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.
#---------------------------------------------------------------------------
...
class Vifs(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.vifs'
    """
...
class VirtualMachines(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.virtual_machines'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _VifsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/realized-state/enforcement-points/{enforcement-point-name}/vifs',
            path_variables={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.vifs',
...
class _VirtualMachinesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/realized-state/enforcement-points/{enforcement-point-name}/virtual-machines',
            path_variables={
                'enforcement_point_name': 'enforcement-point-name',
            },
            query_parameters={
        ...
        updatetags_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/policy/api/v1/global-infra/realized-state/enforcement-points/{enforcement-point-name}/virtual-machines?action=update_tags',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.virtual_machines',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'firewalls': 'com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.firewalls_client.StubFactory',
        'groups': 'com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.groups_client.StubFactory',
        'ip_sets': 'com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.ip_sets_client.StubFactory',
        'mac_sets': 'com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.mac_sets_client.StubFactory',
        'services': 'com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.services_client.StubFactory',
        'virtual_machines': 'com.vmware.nsx_policy.global_infra.realized_state.enforcement_points.virtual_machines_client.StubFactory',
    }
