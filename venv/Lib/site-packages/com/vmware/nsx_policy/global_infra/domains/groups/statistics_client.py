...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.domains.groups.statistics.
#---------------------------------------------------------------------------
...
class VirtualMachines(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.domains.groups.statistics.virtual_machines'
    """
...
class _VirtualMachinesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/domains/{domain-id}/groups/{group-id}/statistics/virtual-machines',
            path_variables={
                'domain_id': 'domain-id',
                'group_id': 'group-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.domains.groups.statistics.virtual_machines',
