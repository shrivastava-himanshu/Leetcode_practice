...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.domains.redirection_policies.
#---------------------------------------------------------------------------
...
class Rules(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.domains.redirection_policies.rules'
    """
...
class _RulesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/policy/api/v1/global-infra/domains/{domain-id}/redirection-policies/{redirection-policy-id}/rules/{rule-id}',
            path_variables={
                'domain_id': 'domain-id',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/policy/api/v1/global-infra/domains/{domain-id}/redirection-policies/{redirection-policy-id}/rules',
            path_variables={
                'domain_id': 'domain-id',
                'redirection_policy_id': 'redirection-policy-id',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.nsx_policy.global_infra.domains.redirection_policies.rules',
