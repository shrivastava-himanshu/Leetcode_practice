...
#
# vAPI stub file for package com.vmware.nsx_policy.global_infra.domains.communication_maps.
#---------------------------------------------------------------------------
...
class CommunicationEntries(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.nsx_policy.global_infra.domains.communication_maps.communication_entries'
    """
