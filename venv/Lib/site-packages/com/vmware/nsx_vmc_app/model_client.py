...
class SddcUserConfiguration(VapiStruct):
    ...
    def __init__(self,
        ...
        :param all_uplink_interface_label: All uplink interfaces label name. Deprecated, please use labels.
        :type  all_vpn_interface_label: :class:`str` or ``None``
        :param all_vpn_interface_label: All VPN interfaces label name. Deprecated, please use labels.
        ...
        :param compute_domain: Compute domain ID. Deprecated, please use domains.
        :type  compute_gateway: :class:`str` or ``None``
        :param compute_gateway: Compute gateway name. Deprecated, please use gateways.
        ...
        :param dx_interface_label: DirectConnect interface label name. Deprecated, please use labels.
        ...
        :param interfaces: Interfaces (labels) including public interface, direct connect
            interface, linked vpc interface, etc. Deprecated, please use
            labels.
        ...
        :param linked_vpc_interface_label: Linked VPC interface label name. Deprecated, please use labels.
        :type  management_domain: :class:`str` or ``None``
        :param management_domain: Management domain ID. Deprecated, please use domains.
        :type  management_gateway: :class:`str` or ``None``
        :param management_gateway: Management gateway name. Deprecated, please use gateways.
        :type  management_gateway_default_dns_zone: :class:`ProviderObject` or ``None``
        :param management_gateway_default_dns_zone: Management gateway default DNS zone
        :type  management_gateway_label: :class:`str` or ``None``
        :param management_gateway_label: Management gateway label name. Deprecated, please use labels.
        :type  mgmt_subnet: :class:`list` of :class:`str` or ``None``
        :param mgmt_subnet: Management subnet CIDRs. Deprecated, please use mgmt_subnets.
        ...
        :param provider_gateways: Provider gateway list. Including both tier-0 gateways and tier-1
            gateways. Deprecated, please use gateways.
        :type  provider_name: :class:`str` or ``None``
        :param provider_name: Service provider name. Deprecated, please use gateways.
        ...
        :param public_interface_label: Public interface label name. Deprecated, please use labels.
        :type  sddc_infra_subnet: :class:`list` of :class:`str` or ``None``
        :param sddc_infra_subnet: SDDC infra subnet CIDRs. Deprecated, please use infra_subnets.
            format: ipv4-cidr-block
...
class UpgradeVersionInfo(VapiStruct):
    """
    ...
    _canonical_to_pep_names = {
                            'from_sddc_version': 'from_sddc_version',
                            'to_sddc_version': 'to_sddc_version',
                            }

    def __init__(self,
                 from_sddc_version=None,
                 to_sddc_version=None,
                ):
        """
        :type  from_sddc_version: :class:`str` or ``None``
        :param from_sddc_version: The version of SDDC on which the upgrade is started.
            This attribute may be present in responses from the server, but if
            it is present in a request to server it will be ignored.
        :type  to_sddc_version: :class:`str` or ``None``
        :param to_sddc_version: The version to which the SDDC is upgraded. port.
            This attribute may be present in responses from the server, but if
            it is present in a request to server it will be ignored.
        """
        self.from_sddc_version = from_sddc_version
        self.to_sddc_version = to_sddc_version
        VapiStruct.__init__(self)


UpgradeVersionInfo._set_binding_type(type.StructType(
    'com.vmware.nsx_vmc_app.model.upgrade_version_info', {
        'from_sddc_version': type.OptionalType(type.StringType()),
        'to_sddc_version': type.OptionalType(type.StringType()),
    },
    UpgradeVersionInfo,
    False,
    None))
